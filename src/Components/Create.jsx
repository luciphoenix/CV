      ...
      <div className="createBody">
        <form action="#" method="post">
          ...
          <div id="education">
            ...
            <button type="button" onClick={edu.handleNewSchool}>
              ADD
            </button>
          </div>
          <div className="experience">
            ...
            <button type="button" onClick={experiences.handleNewExperience}>
              ADD
            </button>
          </div>
          <div className="skill">
            ...
            <button type="button" onClick={skillData.handleNewSkill}>
              ADD
            </button>
          </div>
          <div className="language">
            ...
            <button type="button" onClick={spoken.handleNewLanguage}>
              ADD
            </button>
          </div>
          <div className="references">
            ...
            <button type="button" onClick={references.handleNewReference}>
              ADD
            </button>
          </div>
